...
(nos ofrecieron uno ya hecho) para hacerlo a mi gusto. Se puede acceder como usuario, administrador y técnico;
los usuarios pueden crear incidencias, editarlas, eliminarlas (baja lógica, permanece en la base de datos) y reabrirlas.
